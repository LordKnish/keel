        ...
        <div className="help-modal__content">
          ...
          <div className="help-modal__section">
            <p className="help-modal__intro">
              Identify the mystery warship in 5 guesses or fewer.
            </p>
          </div>
          ...
          <div className="help-modal__section">
            ...
            <ul className="help-modal__list">
              <li>View the ship's silhouette and any revealed clues</li>
              <li>Search for a ship and submit your guess</li>
          ...
          <div className="help-modal__section">
            ...
            <ul className="help-modal__list">
              ...
              <li><strong>Turn 2:</strong> Ship specifications</li>
          ...
          <div className="help-modal__credits">
            ...
            <p className="help-modal__credits-subtext">A new ship every day</p>
          </div>
        </div>
      </div>
    </div>
